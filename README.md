...
flowchart LR
    ...
    Cliente -->|"GET /api/v1/contas"| UC0["Listar Contas"]
...
|--------|----------|-----------|--------|
| `GET` | `/api/v1/contas` | Listar todas as contas | `200` |
| `POST` | `/api/v1/contas` | Criar nova conta | `201` |
| `GET` | `/api/v1/contas/{id}` | Consultar conta e saldo | `200` |
...
**Listar contas:**
```bash
curl http://localhost:8080/api/v1/contas
```
